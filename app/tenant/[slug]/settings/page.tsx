    ...
    (async () => {
      try {
        ...
        if (sRes.ok) {
          ...
          fetchedSettings = { ...DEFAULT_SETTINGS, ...s }; // Merge with defaults
        } else {
               ...
               <div className="space-y-6">
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                   <div className="p-4 rounded-lg border border-border">
                     ...
                     <button className="text-xs text-orange-600 hover:underline font-semibold">View All</button>
                   </div>
                   ...
                   <div className="p-4 rounded-lg border border-border">
                     ...
                     <p className="text-xs text-muted-foreground mt-2">65% of quota used</p>
                   </div>
                 </div>
                 ...
                 <div>
                   ...
                   <div className="space-y-3">
                     <div className="p-4 rounded-lg border border-border">
                       <div className="flex items-center justify-between mb-2">
                         <p className="text-sm font-medium">Patient Events</p>
                         <span className="text-xs px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">Active</span>
                       </div>
                       <p className="text-xs text-muted-foreground font-mono">https://webhook.hospital.com/events/patients</p>
                       <div className="flex gap-2 mt-3">
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted">Edit</button>
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted">Test</button>
                         <button className="text-xs px-3 py-1.5 rounded border border-red-200 text-red-600 hover:bg-red-50">Remove</button>
                       </div>
                     </div>

                     <div className="p-4 rounded-lg border border-border">
                       <div className="flex items-center justify-between mb-2">
                         <p className="text-sm font-medium">Appointment Notifications</p>
                         <span className="text-xs px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">Active</span>
                       </div>
                       <p className="text-xs text-muted-foreground font-mono">https://webhook.hospital.com/events/appointments</p>
                       <div className="flex gap-2 mt-3">
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted">Edit</button>
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted">Test</button>
                         <button className="text-xs px-3 py-1.5 rounded border border-red-200 text-red-600 hover:bg-red-50">Remove</button>
                   ...
                   <button className="mt-3 inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:bg-muted text-sm">
                   ...
                   <div className="space-y-3">
                     <div className="p-4 rounded-lg border border-border">
                       <div className="flex items-center justify-between mb-2">
                         ...
                         <span className="text-xs px-2 py-1 rounded-full bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400">Active</span>
                       </div>
                       <p className="text-xs text-muted-foreground font-mono">hsk_prod_*********************</p>
                       <p className="text-xs text-muted-foreground mt-1">Created 30 days ago • Last used: 2 hours ago</p>
                       <div className="flex gap-2 mt-3">
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted flex items-center gap-1">
                           <Copy className="size-3" /> Copy Key
                         </button>
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted">Rotate</button>
                         <button className="text-xs px-3 py-1.5 rounded border border-red-200 text-red-600 hover:bg-red-50">Revoke</button>
                       </div>
                     </div>
                     ...
                     <div className="p-4 rounded-lg border border-border">
                       ...
                       <p className="text-xs text-muted-foreground font-mono">hsk_dev_*********************</p>
                       <p className="text-xs text-muted-foreground mt-1">Created 3 days ago • Last used: Never</p>
                       <div className="flex gap-2 mt-3">
                         <button className="text-xs px-3 py-1.5 rounded border border-border hover:bg-muted flex items-center gap-1">
                           <Copy className="size-3" /> Copy Key
                         </button>
                   ...
                   <div className="space-y-2 text-xs">
                     <div className="p-3 rounded-lg border border-border flex items-center justify-between">
                       <div>
                         ...
                         <p className="text-muted-foreground">Successfully sent 156 emails</p>
                       </div>
                       <span className="text-muted-foreground">2 hours ago</span>
                     </div>
                     <div className="p-3 rounded-lg border border-border flex items-center justify-between">
                       <div>
                         <p className="font-medium">Twilio SMS delivery</p>
                         <p className="text-muted-foreground">Successfully sent 42 messages</p>
                       </div>
                       <span className="text-muted-foreground">4 hours ago</span>
                     </div>
                     <div className="p-3 rounded-lg border border-border flex items-center justify-between">
                       <div>
                         <p className="font-medium">Stripe webhook processed</p>
                         <p className="text-muted-foreground">Payment confirmed for 8 transactions</p>
                       </div>
             ...
             >
               <div className="space-y-6">
                     ...
                     <div className="flex items-center justify-between p-3 rounded-lg border border-border">
                       <div className="flex items-center gap-3">
                         ...
                         <div>
                           ...
                           <p className="text-xs text-muted-foreground">3/3 running normally</p>
                         </div>
                       </div>
                       <span className="text-xs px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">Healthy</span>
                     </div>
                     ...
                     <div className="flex items-center justify-between p-3 rounded-lg border border-border">
                       <div className="flex items-center gap-3">
                         ...
                         <div>
                           ...
                           <p className="text-xs text-muted-foreground">8.2 TB available</p>
                         </div>
                       </div>
                       <span className="text-xs px-2 py-1 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">Healthy</span>
                     </div>
                     ...
                     <div className="flex items-center justify-between p-3 rounded-lg border border-border">
                       <div className="flex items-center gap-3">
                         ...
                         <div>
                           ...
                           <p className="text-xs text-muted-foreground">High memory usage: 87%</p>
                         </div>
                       </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     ...
                     <div>
                       <div className="flex items-center justify-between mb-2">
                         ...
                         <span className="text-xs font-semibold text-emerald-600">68%</span>
                       </div>
                       <div className="w-full bg-border rounded-full h-2">
                     ...
                     <div>
                       <div className="flex items-center justify-between mb-2">
                         ...
                         <span className="text-xs font-semibold text-emerald-600">55%</span>
                       </div>
                       <div className="w-full bg-border rounded-full h-2">
                     ...
                     <div>
                       <div className="flex items-center justify-between mb-2">
                         ...
                         <span className="text-xs font-semibold text-orange-600">78%</span>
                       </div>
                       <div className="w-full bg-border rounded-full h-2">
                 ...
                 <div>
                   ...
                   <div className="space-y-2">
                     <div className="p-3 rounded-lg border border-yellow-200 dark:border-yellow-500/30 bg-yellow-50/50 dark:bg-yellow-500/5">
                       <div className="flex items-start gap-2">
                         <AlertCircle className="size-4 text-yellow-600 mt-0.5 shrink-0" />
                         <div className="flex-1">
                           <p className="text-sm font-medium text-yellow-700 dark:text-yellow-400">High cache memory usage</p>
                           <p className="text-xs text-muted-foreground mt-1">Memory usage has reached 87%. Consider clearing old cache entries.</p>
                         </div>
                       </div>
                     </div>

                     <div className="p-3 rounded-lg border border-blue-200 dark:border-blue-500/30 bg-blue-50/50 dark:bg-blue-500/5">
                       <div className="flex items-start gap-2">
                         <AlertCircle className="size-4 text-blue-600 mt-0.5 shrink-0" />
                         <div className="flex-1">
                           <p className="text-sm font-medium text-blue-700 dark:text-blue-400">Scheduled maintenance window</p>
                           <p className="text-xs text-muted-foreground mt-1">Database maintenance scheduled for tonight 2:00 AM - 3:00 AM UTC</p>
                         </div>
                       </div>
                     </div>
                   </div>
                 ...
                 <div className="flex gap-2">
                   ...
                   <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border hover:bg-muted text-sm">
                     <Settings className="size-4" /> Configure Alerts
                   </button>
                 </div>
               </div>
             </Card>
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Toggle label="Automated backups" desc="Daily encrypted backups" value={true} onChange={() => {}} />
