...
export async function GET(
  ...
  try {
    ...
    const range = new URL(request.url).searchParams.get("range") || "12months";
    const interval = range === "3months" ? "3 months" : range === "6months" ? "6 months" : range === "24months" ? "24 months" : "12 months";
