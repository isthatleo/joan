...
import { ArrowLeft, CheckCircle2, Download, FlaskConical, Loader2, Repeat2 } from "lucide-react";
...
export default function LabResultDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Topbar breadcrumbs={[{ label: "Dashboard", href: "/doctor" }, { label: "Lab Results", href: "/lab-results" }, { label: "Details" }]} />
            ...
            <section className="space-y-4 rounded-2xl border border-border bg-card p-5 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">{result.testCode} · {result.category || "General"}</p>
                </div>
