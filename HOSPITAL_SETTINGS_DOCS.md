...
```bash
# Get settings
curl -X GET "https://joanhealth.tech//api/hospital/settings?tenantId=..."

# Update settings
curl -X PUT "https://joanhealth.tech//api/hospital/settings?tenantId=..." \
  -H "Content-Type: application/json" \
  -d '{"hospital":{"name":"New Name"}}'

# List integrations
curl -X GET "https://joanhealth.tech//api/hospital/integrations?tenantId=..."

# Add integration
curl -X POST "https://joanhealth.tech//api/hospital/integrations?tenantId=..." \
  -H "Content-Type: application/json" \
