...
- **Web App**: https://joanhealth.tech/
- **API**: https://joanhealth.tech//api
- **WebSocket**: ws://localhost:4000
- **Docs**: https://joanhealth.tech//docs
...
```bash
# Create patient
curl -X POST https://joanhealth.tech//api/patients \
  -H "Content-Type: application/json" \
  -d '{"firstName":"John","lastName":"Doe","tenantId":"..."}'

# Create appointment
curl -X POST https://joanhealth.tech//api/appointments \
  -H "Content-Type: application/json" \
  -d '{"patientId":"...","doctorId":"...","scheduledAt":"2026-04-20T10:00:00Z"}'

# Add to queue
curl -X POST https://joanhealth.tech//api/queue/add \
  -H "Content-Type: application/json" \
  -d '{"tenantId":"...","patientId":"...","departmentId":"...","priority":"normal"}'

# Get AI summary
curl https://joanhealth.tech//api/ai/summary/[patientId]
```
...
- Full docs: https://joanhealth.tech//docs
